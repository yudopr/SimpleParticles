...
let particleParams1 = {
	...
	start: {
		...
		color:
			"green" /* random return random color from #000000 to #ffffff, any other CSS acceptable colours */,
	},
	end: {
		x: { from: 100, to: 300 },
		y: { from: 300, to: 320 },
...
function onDOMLoaded(e) {
    ...
    theParticles.addParticle('#particle_container', particleParams1);
